            ...
            <motion.div variants={itemVariants}>
                <Card className="bg-background/40 backdrop-blur-md border-primary/20">
                    <CardContent className="p-4 flex items-center gap-4">
                        <Image src="/gabi-avatar.png" width={64} height={64} alt="Gabi Avatar" className="rounded-full flex-shrink-0 border-2 border-primary/50" data-ai-hint="robot assistant" />
                        <div className="space-y-1">
                            <h1 className="text-xl font-bold">Hi, I'm Gabi!</h1>
                            <p className="text-muted-foreground text-sm">Your AI business co-pilot.</p>
                             <div className="flex items-center gap-2 pt-1">
                                <div className="relative flex h-2.5 w-2.5">
                                    <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-emerald-400 opacity-75"></span>
                                    <span className="relative inline-flex rounded-full h-2 w-2 bg-emerald-500"></span>
                                </div>
                                <p className="text-xs font-semibold text-muted-foreground">Online – Ready to assist you</p>
                            </div>
                        </div>
                    </CardContent>
                </Card>
