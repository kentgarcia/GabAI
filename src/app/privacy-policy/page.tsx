    ...
    <div className="min-h-screen bg-white p-6 text-black">
      ...
      <main className="max-w-2xl mx-auto">
        ...
        <div className="space-y-6 text-gray-700">
          <div>
            <h2 className="text-xl font-semibold mb-2">Our Commitment to Your Privacy</h2>
            <p>
          ...
          <div>
            <h2 className="text-xl font-semibold mb-2">1. The Information We Don't Collect</h2>
            <p>
          ...
          <div>
            <h2 className="text-xl font-semibold mb-2">2. Information We Do Collect</h2>
            <p>
           ...
           <div>
            <h2 className="text-xl font-semibold mb-2">4. Your Control and Rights</h2>
            <p>
