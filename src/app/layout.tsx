  ...
  return (
    <html lang="en">
      ...
      <body className="font-body antialiased bg-background">
        <div className="mobile-app-container relative z-10 mx-auto flex min-h-screen w-full sm:max-w-sm flex-col sm:border-x border-border bg-background sm:shadow-2xl overflow-hidden">
